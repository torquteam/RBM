...
num_basis_states_f = [3,3,4,3,3,4,3,3,3,6,2]
num_basis_states_g = [3,3,4,3,3,4,3,3,3,6,2]
num_basis_states_c = [4,3,4,3,3,5,3,4,3,5,2]
num_basis_states_d = [4,3,4,3,3,5,3,4,3,5,2]
num_basis_states_s = 7
num_basis_states_v = 7
num_basis_states_b = 7
num_basis_states_a = 3
mNuc_mev = 939
mOmega = 782.5
mRho = 763.0
