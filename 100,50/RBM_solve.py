...
lib = ctypes.CDLL('./100,50/c_functions.so')
...
basis_list = [3,3,4,3,3,4,3,3,3,6,2] + [3,3,4,3,3,4,3,3,3,6,2] + [4,3,4,3,3,5,3,4,3,5,2] + [4,3,4,3,3,5,3,4,3,5,2] + [7,7,7,3]
#print(basis_list)
first_basis_list = np.zeros_like(basis_list)
for i in range(len(basis_list)):
    index = sum(basis_list[0:i])
    first_basis_list[i] = index
...
for i in range(nruns):
    ...
    #params = [ 5.02108520e+02, 1.15872333e+02,  1.94862994e+02,  9.70614204e+01, 3.06692224e+00, -5.79572644e-03,  1.69022558e-02,  1.86578202e-02]
