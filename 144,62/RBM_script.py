...
num_basis_states_f = [4,3,3,3,3,4,2,2,3,5,2,4,3,5,2,3]
num_basis_states_g = [4,3,3,3,3,4,2,2,3,5,2,4,3,5,2,3]
num_basis_states_c = [3,3,4,3,3,4,2,3,4,5,2,4,3]
num_basis_states_d = [3,3,4,3,3,4,2,3,4,5,2,4,3]
...
# Specify common grid
r_vec = func.load_data(dir + "/rvec.txt")
