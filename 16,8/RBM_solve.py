...
lib = ctypes.CDLL('./16,8/c_functions.so')
...
energies_p = func.load_data(dir + "/proton/energies.txt")
energies_n = func.load_data(dir + "/neutron/energies.txt")
...
for i in range(nruns):
    ...
    BA_mev = (BA_function(solution.x,params)*13.269584506383948 - 0.75*41.0*A**(-1.0/3.0))/A - 939
