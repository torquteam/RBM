...
actual = np.loadtxt("208,82/208,82,Data/neutron/f_wave/state1s1;2.txt")
#wave = np.loadtxt("208,82/High_fidelity_sol/Fn.txt")
#meson = np.loadtxt("208,82/High_fidelity_sol/meson_fields.txt")/enscale_mev
plt.plot(rvec,f_basis[0][:,0],ls='dashed') #
plt.plot(rvec,actual) #
