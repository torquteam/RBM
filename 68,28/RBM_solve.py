...
lib = ctypes.CDLL('./68,28/c_functions.so')
...
# Set the couplings
#param_set = func.load_data("param_sets_error.txt")
...
for i in range(50):
    ...
    solution = root(c_function_wrapper, x0=initial_guess_array, args=(params_array,), jac=compute_jacobian_wrapper, method='lm',tol=1e-18)
