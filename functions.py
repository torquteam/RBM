...
def get_BA(nstates_n, nstates_p,state_info_n,state_info_p,solution,s_field_approx,v_field_approx,b_field_approx,a_field_approx,sdensn,sdensp,vdensn,vdensp,params,r_vec,A):
    r0_fm = 1.25
